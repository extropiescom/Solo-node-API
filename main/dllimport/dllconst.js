...
DLLDEVINFO.TYPE.PAEW_DEV_INFOTYPE_LCD_STATE = 0x00000100;
//pin state
DLLDEVINFO.PINSTATE = {};
...
//lcd state
DLLDEVINFO.LCDSTATE = {};
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_NULL = 0x00000000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWLOGO = 0x00000001;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_WAITTING = 0x00000002;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWOK = 0x00000004;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWCANCEL = 0x00000008;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWSKEYHASH = 0x00000010;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWADDRESS = 0x00000020;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWBTCSIGN = 0x00000040;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWETHSIGN = 0x00000080;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SETNEWPIN = 0x00000100;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_CHANGEPIN = 0x00000200;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_VERIFYPIN = 0x00000400;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_PINLOCKED = 0x00000800;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_FORMAT = 0x00001000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_REBOOT = 0x00002000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWBIP39 = 0x00004000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_CHECKBIP39 = 0x00008000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWBTSSIGN = 0x00010000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_PINERROR  = 0x00020000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SELECT_MNENUM = 0x00040000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWM = 0x00080000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWTIMEOUT = 0x00100000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWEOSSIGN = 0x00200000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWFAIL = 0x00400000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_SHOWNEOSIGN = 0x00800000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_WAITING_TIMEOUT = 0x01000000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_GET_MNENUM = 0x02000000;
DLLDEVINFO.LCDSTATE.PAEW_DEV_INFO_LCD_GETMNE_BYDEV = 0x04000000;
//session key hash
